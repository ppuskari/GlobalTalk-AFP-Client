...
static void usage(const char *prog)
{
    fprintf(stderr,
            ...
            "\n"
            "This is a one-shot browser, not an interactive shell.\n"
            "To browse deeper, include /VOLUME/path in AFP_URL and run it again.\n"
            "\n"
            ...
            "\n"
            "Force a specific AFP version when diagnosing compatibility:\n"
