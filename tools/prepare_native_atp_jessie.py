...
# predates ATP_MAXRESP and expects struct at_addr to be visible before atp.h is
# parsed.  Keep the tracked native source portable; emit a build-only copy.
...
include_new = '''#include <netatalk/at.h>\n/* Jessie libatalk needs struct at_addr defined before atp.h is parsed. */\n#include <atalk/ddp.h>\n#include <atalk/atp.h>\n#include <atalk/netddp.h>\n'''
